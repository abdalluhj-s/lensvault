    ...
    <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center px-4 py-12">
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 p-8 shadow-2xl backdrop-blur-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Sign in to LensVault</h1>
          <p className="mt-1 text-xs text-zinc-400">Access your authentic photography portfolio & purchases</p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="photographer@lensvault.com"
